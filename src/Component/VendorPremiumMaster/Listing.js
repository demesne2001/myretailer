  ...
  return (
    <>
      ...
      <section class="home-section">
        ...
        <Header ScreenName="Vendor Premium Master"></Header>
          ...
          <Modal.Body>
            <div class="modal-body">
              ...
              <div class="fromdate-vendor">
                ...
                <input type="text" id="addFromDate" placeholder="DD/MM/YYYY" class="datepicker form-control" autocomplete="off" required />
              </div>

              <div class="todate-vendor">
                <label for="editToDate">To Date<span style={{ color: "red" }}>*</span></label>
                <input type="text" id="addToDate" placeholder="DD/MM/YYYY" class="datepicker form-control" autocomplete="off" required />
              </div>
            </div>
          </Modal.Body>
          <Modal.Footer>
                ...
                <div class="card-body">
                  <div class="vendor-sponser-subheader">
                    <div class="form-group row">
                      ...
                      <div class="col-md-4 row">
                        <div class="col-md-8">
                          <input type="button" value="Go" id="btnGo" class="btn btn-primary vendorsponser-btn" />
                        </div>
                      </div>
                    </div>
                  </div>
